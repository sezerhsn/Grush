...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface GRUSHTokenInterface extends Interface {
    getFunction(nameOrSignature: "BURNER_ROLE" | "DEFAULT_ADMIN_ROLE" | "DOMAIN_SEPARATOR" | "MINTER_ROLE" | "PAUSER_ROLE" | "allowance" | "approve" | "balanceOf" | "burn" | "burnFrom" | "decimals" | "eip712Domain" | "getRoleAdmin" | "grantRole" | "hasRole" | "mint" | "name" | "nonces" | "pause" | "paused" | "permit" | "renounceRole" | "revokeRole" | "supportsInterface" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "unpause"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "Burned" | "BurnedFrom" | "EIP712DomainChanged" | "Minted" | "Paused" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer" | "Unpaused"): EventFragment;
...
decodeFunctionResult(functionFragment: 'unpause', data: BytesLike): Result;
    ...
    export namespace BurnedFromEvent {
      export type InputTuple = [from: AddressLike, by: AddressLike, amount: BigNumberish];
      export type OutputTuple = [from: string, by: string, amount: bigint];
      export interface OutputObject {from: string, by: string, amount: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface GRUSHToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): GRUSHToken;
    waitForDeployment(): Promise<this>;

    interface: GRUSHTokenInterface;
...
getEvent(key: 'BurnedFrom'): TypedContractEvent<BurnedFromEvent.InputTuple, BurnedFromEvent.OutputTuple, BurnedFromEvent.OutputObject>;
...
getEvent(key: 'Unpaused'): TypedContractEvent<UnpausedEvent.InputTuple, UnpausedEvent.OutputTuple, UnpausedEvent.OutputObject>;
    ...
    filters: {
      ...
      'BurnedFrom(address,address,uint256)': TypedContractEvent<BurnedFromEvent.InputTuple, BurnedFromEvent.OutputTuple, BurnedFromEvent.OutputObject>;
      BurnedFrom: TypedContractEvent<BurnedFromEvent.InputTuple, BurnedFromEvent.OutputTuple, BurnedFromEvent.OutputObject>;
